    ...
    <div className="flex items-center gap-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm border text-center border-neutral-400 rounded-sm hover bg-white focus:outline-none focus:ring-0"
        ></input>
      ) : (
        <button
          onClick={() => {
...
export const Toolbar = () => {
  ...
  return (
    <div className="bg-[#f1f4f9] px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center gap-x-0.5 overflow-x">
      {sections[0].map((item) => (
